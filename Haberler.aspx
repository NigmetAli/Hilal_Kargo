            ...
            <div class="row">
                <div class="page-title">
                    <div class="col-sm-12 col-md-6 kurumsalBaslik text-left">
                        <h3>HABERLER /
                            <asp:Literal ID="ltrGelenHaberAdi" runat="server"></asp:Literal></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-md-push-3 col-xs-12">
                    ...
                    <div id="post-slider" class="owl-carousel owl-theme margin-bottom-30">
                        <div class="item">
                         <a class="tt-lightbox" href="resimler/haber.png">
                                <img class="img-responsive" src="resimler/haber.png" alt=""></a>                    
                        </div>

                    </div>

                    <asp:Literal ID="ltrHaber" runat="server"></asp:Literal>
                    ...
                    <div class="theiaStickySidebar">
                        <div class="side-bar-services">
                            <ul class="side-bar-list">
                                <asp:Literal ID="ltrHaberKategori" runat="server"></asp:Literal>
