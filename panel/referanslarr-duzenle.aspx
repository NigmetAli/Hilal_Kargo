<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="referanslarr-duzenle.aspx.cs" Inherits="panel_referanslarr_duzenle" %>
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="last" style="height: 22px">
                    ...
                    <br />
                     <span style=" color:Red; font-size:large;">Resim Boyutu 900x600 Oranında Olmalı!</span><br />
