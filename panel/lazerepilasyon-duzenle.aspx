<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="lazerepilasyon-duzenle.aspx.cs" Inherits="panel_lazerepilasyon_duzenle" %>
    ...
    <div class="table">
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <tr>
                <td class="first" width="70">Meta Title<br/>(<b style="color:red;font-size: 10px;font-weight: normal;">Max 80 Karakter</b>):
                </td>
                <td class="last">
            ...
            <tr>
                <td class="first" width="70">Meta Keyword<br/>(<b style="color:red;font-size: 10px;font-weight: normal;">Max 20 Kelime</b>):
                </td>
                <td class="last">
            ...
            <tr>
                <td class="first" width="70">Meta Description<br/>(<b style="color:red;font-size: 10px;font-weight: normal;">Max 160 Karakter</b>):
                </td>
                <td class="last">
