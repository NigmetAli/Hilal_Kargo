<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="hizmetler-duzenle.aspx.cs" Inherits="panel_hizmetler_duzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="table">
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="first" width="100">Meta Keyword<br/>(<b style="color:red;font-size: 10px;font-weight: normal;">Max 20 Kelime</b>):
                </td>
                <td class="last">
