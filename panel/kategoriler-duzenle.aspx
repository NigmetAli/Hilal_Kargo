<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true"
    CodeFile="kategoriler-duzenle.aspx.cs" Inherits="panel_kategoriler_duzenle" %>
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <asp:DropDownList Enabled="false" ID="DropDownList1" runat="server" 
                    ...
                    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [Id], [Adi] FROM [kategori]"></asp:AccessDataSource>
            ...
            <tr>
                ...
                <td class="last">
                    ...
                    <asp:Button CssClass="buton" ID="Button3" runat="server" Text="Sil" CommandName="sil"
