<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="istatistik.aspx.cs" Inherits="panel_istatistik" %>
    ...
    <asp:Repeater ID="RptDaire" runat="server">
            ...
            <table id="dyntable" class="table table-bordered responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="25%" style="font-weight: bold; font-size: 14px; text-transform: uppercase; font-family: Candara;">Tekil Ziyaretçi</th>
                        <th width="25%" style="font-weight: bold; font-size: 14px; text-transform: uppercase; font-family: Candara;">Çoğul Ziyaretçi</th>
                        <th width="30%" style="font-weight: bold; font-size: 14px; text-transform: uppercase; font-family: Candara;">Tarih</th>
                    </tr>
        ...
        <ItemTemplate>
            <tr class="gradeX">
                ...
                <td style="font-family: Candara; font-size: 14px; font-weight: bold; line-height: 28px; vertical-align: middle;"><%#Eval("tekil") %> - Adet</td>
                <td style="font-family: Candara; font-size: 14px; font-weight: bold; line-height: 28px; vertical-align: middle;"><%#Eval("cogul") %> - Adet</td>
                <td style="font-family: Candara; font-size: 14px; font-weight: bold; line-height: 28px; vertical-align: middle;"><%#Eval("gun","{0:D}") %></td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
            </table>
