<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="istatistik-gelenip.aspx.cs" Inherits="panel_istatistik_gelenip" %>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="AccessDataSource1">
        <AlternatingItemTemplate>
            <tr>
                 ...
                 <td>
                    <asp:Label ID="IP" runat="server" Text='<%# Eval("Ip") %>' />
                </td>
                <td>
