...
public partial class panel_lazerepilasyon_yeni : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        yeni.MetaTitle = KeywordsDonustur(TitleTxt.Text.Trim());
        yeni.MetaKeyword = KeywordsDonustur(KeywordTxt.Text.Trim());
        yeni.MetaDescription = UrlDonustur(DescriptionTxt.Text.Trim());
        ...
        {
            Response.Redirect("lazerepilasyon.aspx");
        }
    }
