<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true"
    CodeFile="urunler-duzenle.aspx.cs" Inherits="panel_urunler_duzenle" %>
        ...
        <table class="listing form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="last" style="height: 22px">
                    ...
                    <br />
                     <span style=" color:Red; font-size:large;">Resim Boyutu 360x240 Oranında Olmalı!</span><br />
